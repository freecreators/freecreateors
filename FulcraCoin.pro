...
build_macosx64 {
    QMAKE_TARGET_BUNDLE_PREFIX = co.FulcraCoin
    BOOST_LIB_SUFFIX=-mt
...
# also add new translations to FulcraCoin.qrc under translations/
...
macx:ICON = src/qt/res/icons/FulcraCoin.icns
macx:TARGET = "FulcraCoin"
